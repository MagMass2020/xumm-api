...
module.exports = async function (expressApp) {
  ...
  const errorHandler = async (e, req, res) => {
    ...
    if (typeof e === 'object' && e !== null && typeof e.noLogging === 'boolean' && e.noLogging) {
      // Don't log to error log, ignoge
    } else {
    ...
    v1: {
      ...
      app: {
        ...
        routes: [
          ...
          { method: 'get', path: 'liquidity-boundaries/:issuer(r[a-zA-Z0-9]{3,})/:iou([^/]{3,})', module: 'liquidity-boundaries' },
          ...
          { method: 'get', path: 'xapp/shortlist', module: 'xapp-shortlist' },
      ...
      platform: {
        ...
        routes: [
          ...
          { method: [ 'get', 'post', 'delete' ], path: 'app-storage' },
          { method: 'get', path: 'curated-assets' },
          ...
          { method: 'post', path: 'xapp/push', module: 'xapp-push' },
          { method: 'post', path: 'xapp/event', module: 'xapp-event' },
        ],
        errorHandler: errorHandler
      },
      console: {
